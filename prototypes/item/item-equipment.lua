data:extend(
    {
        ...
        },
        {
            ...
            icons = {{icon = "__base__/graphics/icons/exoskeleton-equipment.png", icon_size = 64, icon_mipmaps = 4, tint = {r = 0.4, g = 0.804, b = 0.667, a = 0.8}}},
        ...
        },
        {
            ...
            icons = {{icon = "__base__/graphics/icons/personal-laser-defense-equipment.png", icon_size = 64, icon_mipmaps = 4, tint = {r = 0.4, g = 0.804, b = 0.667, a = 0.8}}},
        ...
        },
        {
            ...
            icons = {{icon = "__base__/graphics/icons/night-vision-equipment.png", icon_size = 64, icon_mipmaps = 4, tint = {r = 0.4, g = 0.804, b = 0.667, a = 0.8}}},
